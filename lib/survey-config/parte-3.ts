...
Medellin, CO`,
        ...
        {
          id: 'q31q3-tracking-evidencia',
          codigoOriginal: 'C06.1',
          text: 'C06.1. Adjunte una captura del tracking en tiempo real (mapa o actualización minuto a minuto) que justifica su respuesta a C06.',
          textPt:
            'C06.1. Anexe uma captura do tracking em tempo real (mapa ou atualização minuto a minuto) que justifica a sua resposta a C06.',
          type: 'evidence',
          showIf: eq('q31q3-tracking', '1'),
          required: true,
          internalOnly: true,
          hint: 'Control interno: captura del mapa GPS o del tracking minuto a minuto. No se muestra al cliente en resultados.',
          hintPt:
